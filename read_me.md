...
1. **Paste** your ChatGPT output (and optionally your original prompt).
2. **Select** the context type (General, Academic Research, Essay Writing, Summarisation).
3. **Evaluate** — five concurrent analysis calls fire in parallel, loading each panel progressively.
4. **Review** the Judgment Score breakdown (Reasoning, Completeness, Factual Confidence, Usefulness).
5. **Improve** — click "Help me improve this output" to see a side-by-side rewritten version with green diff highlights.
